...
int main(int argc, char **argv)
{
    ...
    if (argc != 2)
	fail("usage : hbond2noe contactlist");

    ifp = fopen(argv[1], "r");	/* Open contact file in TEXT mode */
    if (!ifp)
    {
	...
	if (abs(i - j) > 5)
	{
	    printf("assign (resid %d and name N) (resid %d and name O) 2.90 0.06 0.06\n", i, j);
	    if (i)
	    {
		printf("assign (resid %d and name O) (resid %d and name O) 4.82 0.09 0.09\n", i-1, j);
		printf("assign (resid %d and name C) (resid %d and name O) 3.65 0.13 0.13\n", i-1, j);
	    }
	}
	else if (abs(i - j) == 3)
	{
	    printf("assign (resid %d and name N) (resid %d and name O) 3.06 0.15 0.15\n", i, j);
	    if (i)
	    {
		printf("assign (resid %d and name O) (resid %d and name O) 5.04 0.12 0.12\n", i-1, j);
		printf("assign (resid %d and name C) (resid %d and name O) 3.92 0.10 0.10\n", i-1, j);
	    }
	}
	else if (abs(i - j) == 4)
	{
	    printf("assign (resid %d and name N) (resid %d and name O) 2.99 0.13 0.13\n", i, j);
	    if (i)
	    {
		printf("assign (resid %d and name O) (resid %d and name O) 4.96 0.12 0.12\n", i-1, j);
		printf("assign (resid %d and name C) (resid %d and name O) 3.79 0.10 0.10\n", i-1, j);
	    }
	}
	else if (abs(i - j) == 5)
	{
	    printf("assign (resid %d and name N) (resid %d and name O) 2.98 0.16 0.16\n", i, j);
	    if (i)
	    {
		printf("assign (resid %d and name O) (resid %d and name O) 4.96 0.16 0.16\n", i-1, j);
		printf("assign (resid %d and name C) (resid %d and name O) 3.80 0.16 0.16\n", i-1, j);
	    }
	}
    }
