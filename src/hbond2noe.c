...
int main(int argc, char **argv)
{
	...
	if (abs(i - j) > 5)
	{
	    printf("assign (resid %d and name H) (resid %d and name O) 1.99 0.15 0.15\n", i, j);
	}
	else if (abs(i - j) == 3)
	{
	    printf("assign (resid %d and name H) (resid %d and name O) 2.17 0.19 0.19\n", i, j);
	}
	else if (abs(i - j) == 4)
	{
	    printf("assign (resid %d and name H) (resid %d and name O) 2.06 0.15 0.15\n", i, j);
	}
	else if (abs(i - j) == 5)
	{
	    printf("assign (resid %d and name H) (resid %d and name O) 2.03 0.18 0.18\n", i, j);
	}
    }
