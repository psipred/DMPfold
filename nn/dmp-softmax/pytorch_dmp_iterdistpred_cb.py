...
def main():
    ...
    network.load_state_dict(torch.load(scriptdir + '/FINAL_fullmap_iterdist_cb_model.pt', map_location=lambda storage, loc: storage))
    ...
    with open(sys.argv[3], 'r') as refpdbfile:
        for line in refpdbfile:
            if line[:4] == 'ATOM' and (line[12:16] == ' CB ' or (line[12:16] == ' CA ' and line[17:20] == 'GLY')):
                # Split the line
